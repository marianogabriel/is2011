	...
	<form name="form" action="/editarCuenta" method="post">
     ...
     <div id="menu" style="position:absolute;top:15%;left:1%;"></div>
		...
		<table border="0" cellpadding="10%" align="center" rules="none">
			<tr><td width="25%" align="center">Editar cuenta de Usuario</td></tr>
			<tr></tr>
			<tr>
			  <td align="right" >
				<table cellpadding="5" border="1" rules="none" align="center">
					<tr>
					   ...
					   <td><input type="text" name="mailPrimario" size="40" maxlength="42" id="mail" value="${usuarioLogeado.mail}"></td>
					</tr>
					<tr>
						<td align="right">Dirección de mail alternativo:&nbsp;</td>
						<td><input type="text" name="mailSecundaro" size="40" maxlength="42" id="mail2" value="${usuarioLogeado.mailSecundario}"></td>
					</tr>
					<tr>
						<td align="right">Nombre:&nbsp;</td>
						<td><input type="text" name="nombreUsr" size="40" maxlength="42" id="nomUsr" value="${usuarioLogeado.nombre}"></td>
					</tr>
					<tr>
						<td align="right">Apellido:&nbsp</td>
						<td><input type="text" name="apellidoUsr" size="40" maxlength="42" id="apeUsr" value="${usuarioLogeado.apellido}"></td>
					</tr>
					<tr>
						<td align="right">Fecha de nacimiento:&nbsp;</td>
						<td><input type="text" name="fechaNacimiento" maxlength="12" size="30" id="fechaNac" value="${usuarioLogeado.fechaNacimiento}"></td>
					</tr>
					<tr>
						<td align="right">Sexo:&nbsp;</td>
						<td><input type="radio" name="tipoSexo" id="masculino" value="M">&nbsp;Hombre&nbsp;
							<input type="radio" name="tipoSexo" id="femenino" value="F">&nbsp;Mujer</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" name="respuestaUsr" size="40" maxlength="42" id="respuesta" value="${usuarioLogeado.respuestaPregunta}"></td>
					</tr>
			...
			<tr>
			  <td align="center"><input type="button" name="limpiar" value="Limpiar" onclick="limpiarCampos();">&nbsp;&nbsp;&nbsp;&nbsp;
			  <input type="button" name="save" value="Guardar" onclick="guardar();"></td>
			</tr> 
		</table>
...
menu1.subitems = new Array([["subitem-0","javascript:editar();","Editar Cuenta","_self"],["subitem-1","javascript:salir();","Cerrar Sesion","_self"]],[["subitem-0","javascript:;","Subir Fotos","_self"],["subitem-1","javascript:;","Editar Fotos","_self"],["subitem-2","javascript:volverMisFotos();","Mis Fotos","_self"]]);
