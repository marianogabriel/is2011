...
<%
	Usuario user = (Usuario) SessionManager.get(request,
			WebUtils.getSessionIdentificator(request)).getElement(
			"user");
...
<body onLoad="menu1.escribeacordeon('menu',22,5);" class="my_body">
	...
	<form name="form" action="/logout_beta" method="post"></form>
...
<script type="text/javascript">
	...
	menu1.subitems = new Array([
			...
			[ [ "subitem-0", "javascript:;", "Subir Fotos", "_self" ],
					...
					[ "subitem-2", "javascript:;", "Mis Fotos", "_self" ] ]);
</script>
</html>